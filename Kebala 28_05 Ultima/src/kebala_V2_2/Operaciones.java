...
public class Operaciones {
	...
	public static void pagoEfectivo() throws Exception {
		...
		double aux1 = (double)(Math.round(cambio * 100D) / 100D);
		System.out.println(green + "\nRecoja su cambio de: " + reset + aux1 + green + " €." + reset);
	...
	public static void crearArchivo() throws Exception {
		...
		String fe = date + " ";
		String data = DatosParaEnvio;
		FileOutputStream out = new FileOutputStream("C:\\Users\\yaros\\Desktop\\DAM\\" + fe + ".txt");
