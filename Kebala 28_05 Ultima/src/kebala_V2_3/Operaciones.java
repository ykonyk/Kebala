...
public class Operaciones {
	...
	public static String correoCliente, DatosParaEnvio = "", DatosParaEsc = "";
	...
	public void seleccionComida() throws Exception {
		short operacion = 0;
		do {
	...
	public void seleccionTipoCarne() throws Exception {
		short operacion = 0;
		do {
	...
	public void seleccionRelleno() throws Exception {
		short operacion = 0;
		do {
	...
	public void seleccionBebida() throws Exception {
		short operacion = 0;
		do {
	...
	public void seleccionExtras() throws Exception {
		short operacion = 0;
		do {
	...
	public void seleccionPostres() throws Exception {
		short operacion = 0;
		do {
	...
	public void cargaFictRetardo() throws Exception {
		System.out.println();
		for (byte v = 0; v < 45; v++) {
	...
	public void finalizarOrden() throws Exception {
		short operacion = 0;
	...
	public void selectorPago() throws Exception {
		short operacion = 0;
		boolean ok = true;
		do {
			ok = true;
	...
	public void pagoEfectivo() throws Exception {
		double operacion = 0;
		do {
			boolean ok = true;
			do {
	...
	public void pagoTarjeta() throws Exception {
		boolean tru;
	...
	public void preguntaEnviarFacturaMail() throws Exception {
		short operacion = 0;
	...
	public void ingresarCorreo() throws Exception {
	...
	public void conversionDatos() throws Exception {// Utilizamos un metodo de conversion y usamos dos variables,	
		String precioStr = String.valueOf(precio); 
		if (check == false) {	                          // para envio y otra escritura para que se unan.
			for (byte x = 0; x < Pedido.size(); x++) {
				String aux3 = Pedido.get(x);
				aux3 += "  ";
				DatosParaEsc += aux3;
			}
			 DatosParaEsc += precioStr;
			EscribirFichero();
		}
		if (check == true) {
			for (byte x = 0; x < Pedido.size(); x++) {
	...
	public void EnviarFacturaMail() throws Exception {
